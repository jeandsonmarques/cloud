...
class PowerBISummarizer:
    ...
    def initGui(self):
        ...
        cloud_icon_path = os.path.join(self.plugin_dir, "resources", "icons", "cloud_database.svg")
        main_icon = QIcon(":/powerbi_summarizer_icons/cloud_database.svg")
        if main_icon.isNull():
            main_icon = QIcon(cloud_icon_path if os.path.exists(cloud_icon_path) else icon_path)
        self.action = QAction(
            main_icon,
